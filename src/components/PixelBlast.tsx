...
const PixelBlast: React.FC<PixelBlastProps> = ({
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      // Defer DPR until we know safe size
      ...
      let raf = 0;
      const animate = () => {
        if (!container.clientWidth || !container.clientHeight || (autoPauseOffscreen && !visibilityRef.current.visible)) {
